...
//				+ " mcode=?  and cr_year=? and cr_season=?  ";
		...
		String sql="   SELECT wbdcode, wbedname,wbmcode,wbemname,wbvcode,wbevname, sum(web_farmers) as web_farmers,  sum(booked_web_ext)  as booked_web_ext,sum(web_ext)\r\n"
				...
				+ "  sum(booked_usus_ext)  as booked_usus_ext,sum(usus_ext) as usus_ext FROM "+tableName+"  where wbdcode=?\r\n"
